...
public class MenuAdapter extends FirebaseRecyclerAdapter<FoodItems,MenuAdapter.MyViewHolder> {
     ...
     * @param options1
     */
    public MenuAdapter(@NonNull FirebaseRecyclerOptions<FoodItems> options1) {
        super(options1);
    }

    public MenuAdapter(@NonNull FirebaseRecyclerOptions<FoodItems> options1,Context mcontext) {
        super(options1);
...
//        holder.description.setText(model.getDescription());
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(mcontext).inflate(R.layout.menu_design,parent,false);
