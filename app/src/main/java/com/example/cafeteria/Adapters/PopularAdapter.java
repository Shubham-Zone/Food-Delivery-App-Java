...
public class PopularAdapter extends FirebaseRecyclerAdapter<FoodItems, PopularAdapter.MyViewHolder> {
     ...
     * @param options
     */
    public PopularAdapter(@NonNull FirebaseRecyclerOptions<FoodItems> options) {
        super(options);
    }
    public PopularAdapter(@NonNull FirebaseRecyclerOptions<FoodItems> options, Context mcontext) {
        super(options);
...
//        holder.description.setText(model.getDescription());
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(mcontext).inflate(R.layout.popular_design,parent,false);
