...
public class RegionalAdapter extends FirebaseRecyclerAdapter<FoodItems,RegionalAdapter.MyViewHolder> {
     ...
     * @param options
     */
    public RegionalAdapter(@NonNull FirebaseRecyclerOptions<FoodItems> options) {
        super(options);
    }

    public RegionalAdapter(@NonNull FirebaseRecyclerOptions<FoodItems> options,Context mcontext) {
        super(options);
