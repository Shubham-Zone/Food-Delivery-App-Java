...
public class SnacksAdapter extends FirebaseRecyclerAdapter<FoodItems, SnacksAdapter.MyViewHolder> {
     ...
     * @param options
     */
    public SnacksAdapter(@NonNull FirebaseRecyclerOptions<FoodItems> options) {
        super(options);
    }
    public SnacksAdapter(@NonNull FirebaseRecyclerOptions<FoodItems> options,Context mcontext) {
        super(options);
