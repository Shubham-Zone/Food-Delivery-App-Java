...
public class SouthIndianAdapter extends FirebaseRecyclerAdapter<FoodItems,SouthIndianAdapter.MyViewHolder> {
     ...
     * @param options
     */
    public SouthIndianAdapter(@NonNull FirebaseRecyclerOptions<FoodItems> options) {
        super(options);
    }

    public SouthIndianAdapter(@NonNull FirebaseRecyclerOptions<FoodItems> options, Context mcontext) {
        super(options);
