...
public class SweetsAdapter extends FirebaseRecyclerAdapter<FoodItems,SweetsAdapter.MyViewHolder> {
     ...
     * @param options
     */
    public SweetsAdapter(@NonNull FirebaseRecyclerOptions<FoodItems> options) {
        super(options);
    }

    public SweetsAdapter(@NonNull FirebaseRecyclerOptions<FoodItems> options,Context mcontext) {
        super(options);
