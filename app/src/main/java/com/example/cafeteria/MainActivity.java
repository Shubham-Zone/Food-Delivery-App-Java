...
import com.example.cafeteria.Adapters.ChineseAdapter;
                ...
                Cartbtn.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if(!l2.isEmpty()) {
                            ...
                            startActivity(new Intent(MainActivity.this,EmptyCart.class));
                        }
                    }
                });
...
//
//
//        list.add(new MainModel(R.drawable.chilli_potato,"Chilli_potato","40","A spicy starter snack made with hot sizzling potatoes."));
//        list.add(new MainModel(R.drawable.chow_mein,"Chow Mein","40","Classical lip smacking receipe made with thin noodles."));
//        list.add(new MainModel(R.drawable.egg_chowmein,"Egg Chowmein","60","Filling and full of flavours, this egg chowmein recipe is filled with eggs, sauces and desi spices."));
//        list.add(new MainModel(R.drawable.paneerchowmeinpng,"Paneer chowmein","60","Filling and full of flavours, this paneer chowmein recipe is filled with paneer, sauces and desi spices."));
//
//
...
//        LinearLayoutManager layoutManager=new LinearLayoutManager(this);
        binding.recyclerview.setLayoutManager(new WrapContentLinearLayoutManager(MainActivity.this,2,  GridLayoutManager.VERTICAL, false));

        //Get data from firebase database
        FirebaseRecyclerOptions<FoodItems> options=
                new FirebaseRecyclerOptions.Builder<FoodItems>()
                        .setQuery(FirebaseDatabase.getInstance().getReference("Food").child("Chinese"), FoodItems.class)
                        .build();

        chineseAdapter =new ChineseAdapter(options,this);
        binding.recyclerview.setAdapter(chineseAdapter);
    ...
    protected void onStart(){
        super.onStart();
        chineseAdapter.startListening();
    }

    @Override
    protected void onStop(){
        super.onStop();
        chineseAdapter.stopListening();
    }
