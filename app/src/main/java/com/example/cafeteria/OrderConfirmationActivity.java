...
//                   Log.d("HeyRam", x[0]);
        ...
        Thread td=new Thread(){
            public void run(){
                try {
                    ...
                    if(status().equals("1")){
                        startActivity(new Intent(OrderConfirmationActivity.this,OrderConfirmed.class));
                    }else if (status().equals("0")){
                        startActivity(new Intent(OrderConfirmationActivity.this,NotAvailable.class));
                    }
                    finish();
                }
            }
    ...
    public void onBackPressed(){
        super.onBackPressed();
        startActivity(new Intent(OrderConfirmationActivity.this,CategoryActivity.class));
        finish();
    }
}